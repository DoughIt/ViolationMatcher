...
import cn.edu.fudan.violationtracker.entity.dto.LocationMatchResult;
import cn.edu.fudan.violationtracker.entity.dto.RawIssueMatchResult;
import cn.edu.fudan.violationtracker.entity.enums.RawIssueStatus;
import cn.edu.fudan.violationtracker.util.CosineUtil;
import cn.edu.fudan.violationtracker.util.JavaAstParserUtil;
import cn.edu.fudan.violationtracker.util.MapSortUtil;
...
public class RawIssueMatcher {
     ...
     */
    public static void match(List<RawIssue> preRawIssues, List<RawIssue> curRawIssues, String preFilePath, String curFilePath) {
        ...
        match(preRawIssues, curRawIssues, curParentName);
    }
    ...
    private static boolean match(RawIssue preRawIssue, RawIssue curRawIssue, Set<String> curParentName) {
        ...
        if (max == 1) {
            ...
            boolean isSame = (ObjectUtils.isEmpty(code1) && ObjectUtils.isEmpty(code2)) || preLocation.isSame(curLocation);
            if (isSame) {
    ...
    private static double calculateMatchDegree(Location location1, Location location2, double tokenSimilarity, Set<String> curParentName) {
        ...
        boolean method1Empty = ObjectUtils.isEmpty(methodName1);
    ...
    public static void matchTwoLocation(Location location1, Location location2, Set<String> curParentName) {
        ...
        boolean isCode1Empty = ObjectUtils.isEmpty(code1);
        boolean isCode2Empty = ObjectUtils.isEmpty(code2);
