package cn.edu.fudan.violationtracker.entity.dbo;
...
public class RawIssue {
    ...
    public static boolean isSameLocation(RawIssue rawIssue1, RawIssue rawIssue2) {
        if (rawIssue1 == null && rawIssue2 == null) {
            return true;
        } else if (rawIssue1 == null || rawIssue2 == null) {
            return false;
        }
        ...
        for (int i = 0; i < locations1.size(); i++) {
            ...
            // todo 文件行变动不算修改
            if (!fieldEquals(location1.getAnchorName(), location2.getAnchorName()) ||
                    !fieldEquals(location1.getCode(), location2.getCode())) {
                return false;
            }
        }
        return true;
    ...
    private static boolean fieldEquals(String field1, String field2) {
